...
public class JdbcSinkConfig extends AbstractConfig {
  ...
  private static final String INSERT_MODE_DOC =
      ...
      + "``merge``\n"
      + "    Use the appropriate bulk merge semantics for the target database if it is supported "
      + "by the connector, e.g., ``MERGE INTO``."
      + "``copy``\n"
      + "    Use the appropriate bulk copy semantics for the target database if it supported by "
      + "the connector, e.g., ``COPY INTO``.";
